...
1. **Official compliance is authoritative-only.**
   - A finding labeled `OFFICIAL-NONCOMPLIANT`, `OFFICIAL-SEMANTIC-ERROR`, or `OFFICIAL-DEPRECATED/LEGACY` MUST be supported by current Anthropic/Claude official documentation.
...
6. Validation plan and available project eval assets.
7. Explicit unknowns/unverified items.
